...
public class GroupController {
    ...
    public ResponseEntity<?> deleteGroup(@PathVariable Long id) {
        ...
        if (group != null) {
            ...
            return ResponseEntity.noContent().build(); // Retorna 204 (Sin contenido) si la eliminación fue exitosa.
        } else {
            return ResponseEntity.notFound().build(); // Retorna 404 (No encontrado) si el grupo no existe.
        }
    }
}